...
[["second-item1-UE-all", 1], tvjt, {s: {html: "<center><table><table cellspacing=100><tr><td><img style=\"display:block;max-width:700px;max-height:700px;width: auto;height: auto;\" src=\"https://github.com/Rh-Hor/Exp_Dec-2025/blob/main/data_includes/1-all.png?raw=true\"></td></table></center> Kontext: Lorem Ipsum </p><center><p>Boris se dívá na boxy a říká:</p> 1. <i>Všechny trojúhelníky jsou v levém boxu.</i></p></p>Z Borisova pozorování plyne, že:<p> 2. <i>všechny červené trojúhelníky jsou v levém boxu.</i></p> </center>"}}],

[["second-item1-UE-most", 1], tvjt, {s: {html: "<center><table><table cellspacing=100><tr><td><img style=\"display:block;max-width:700;max-height:700px;width: auto;height: auto;\" src=\"https://github.com/Rh-Hor/Exp_Dec-2025/blob/main/data_includes/1-most.png?raw=true\"></td></table></center>Kontext: Lorem Ipsum </p><center><p>Boris se dívá na boxy a říká:</p> 1. <i>Většina trojúhelníků je v levém boxu.</i></p></p>Z Borisova pozorování plyne, že: <p> 2. <i>Většina XXX. </i></p> </center>"}}],

[["second-item1-UE-some", 1], tvjt, {s: {html: "<center><table><table cellspacing=100><tr><td><img style=\"display:block;max-width:700px;max-height:700px;width: auto;height: auto;\" src=\"https://github.com/Rh-Hor/Exp_Dec-2025/blob/main/data_includes/1-some.png?raw=true\"></td></table></center>Kontext: Lorem Ipsum </p><center><p>Boris se dívá na boxy a říká:</p> 1. <i>Některé trojúhelníky jsou v levém boxu.</i></p></p>Z Borisova pozorování plyne, že: <p> 3.<i> Některé XXX</i></p></center>"}}],

["second-filler1-bad", tjt, {s: {html: "<center><table><table cellspacing=100><tr><td><img style=\"display:block;max-width:700px;max-height:700px;width: auto;height: auto;\" src=\"https://github.com/Rh-Hor/Exp_Dec-2025/blob/main/data_includes/1-mixed.png?raw=true\"></td></table></center>Kontext: Známý modní dům pořádal módní přehlídku nové kolekce. Bylo pozváno spoustu důležitých osob a také zástupci módních časopisů. Akci uzavírala noční přehlídka dvou světových modelek. Fotografové měli plné ruce práce.</p><center><p>Boris se dívá na boxy a říká: <i>Každý fotograf vyfotil obě modelky.</i></p></p>Z Borisova pozorování plyne, že</center>"}, as: ["Pravdivost Borisovy první věty zaručuje pravdivost druhé věty", "Pravdivost Borisovy první věty nezaručuje pravdivost druhé věty."]}],  

["second-filler2-bad", tjt, {s: {html: "<center><table><table cellspacing=100><tr><td><img style=\"display:block;max-width:700px;max-height:700px;width: auto;height: auto;\" src=\"https://github.com/Rh-Hor/Exp_Dec-2025/blob/main/data_includes/1-mixed.png?raw=true\"></td></table></center>Kontext: Známý modní dům pořádal módní přehlídku nové kolekce. Bylo pozváno spoustu důležitých osob a také zástupci módních časopisů. Akci uzavírala noční přehlídka dvou světových modelek. Fotografové měli plné ruce práce.</p><center><p>Boris se dívá na boxy a říká: <i>Každý fotograf vyfotil obě modelky.</i></p></p>Z Borisova pozorování plyne, že</center>"}}],  

["second-filler3-bad", tvjt, {s: {html: "<center><table><table cellspacing=100><tr><td><img style=\"display:block;max-width:700px;max-height:700px;width: auto;height: auto;\" src=\"https://github.com/Rh-Hor/Exp_Dec-2025/blob/main/data_includes/1-mixed.png?raw=true\"></td></table></center>Kontext: Známý modní dům pořádal módní přehlídku nové kolekce. Bylo pozváno spoustu důležitých osob a také zástupci módních časopisů. Akci uzavírala noční přehlídka dvou světových modelek. Fotografové měli plné ruce práce.</p><center><p>Boris se dívá na boxy a říká: <i>Každý fotograf vyfotil obě modelky.</i></p></p>Z Borisova pozorování plyne, že</center>"}}],  
