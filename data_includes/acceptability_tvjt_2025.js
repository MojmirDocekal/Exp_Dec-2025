...
[["second-item2-UE-all", 2], aj, {s: {html: "<center><table><table cellspacing=100><tr><td><img style=\"display:block;max-width:700px;max-height:700px;width: auto;height: auto;\" src=\"https://github.com/Rh-Hor/Exp_Dec-2025/blob/main/data_includes/1-all.png?raw=true\"></td></table></center> Kontext: Lorem Ipsum </p><center><p>Boris se dívá na boxy a říká:</p> 1. <i>Všechny trojúhelníky jsou v levém boxu.</i></p></p>Z Borisova pozorování plyne, že:<p> 2. <i>všechny červené trojúhelníky jsou v levém boxu.</i></p> </center>"}, as: ["Pravdivost Borisovy první věty zaručuje pravdivost druhé věty", "Pravdivost Borisovy první věty nezaručuje pravdivost druhé věty."], presentAsScale: false, leftComment: null, rightComment: null}],

[["second-item2-UE-most", 2], aj, {s: {html: "<center><table><table cellspacing=100><tr><td><img style=\"display:block;max-width:700;max-height:700px;width: auto;height: auto;\" src=\"https://github.com/Rh-Hor/Exp_Dec-2025/blob/main/data_includes/1-most.png?raw=true\"></td></table></center>Kontext: Lorem Ipsum </p><center><p>Boris se dívá na boxy a říká:</p> 1. <i>Většina trojúhelníků je v levém boxu.</i></p></p>Z Borisova pozorování plyne, že: <p> 2. <i>Většina XXX. </i></p> </center>"}, as: ["Pravdivost Borisovy první věty zaručuje pravdivost druhé věty", "Pravdivost Borisovy první věty nezaručuje pravdivost druhé věty."], presentAsScale: false, leftComment: null, rightComment: null}],

[["second-item2-UE-some", 2], aj, {s: {html: "<center><table><table cellspacing=100><tr><td><img style=\"display:block;max-width:700px;max-height:700px;width: auto;height: auto;\" src=\"https://github.com/Rh-Hor/Exp_Dec-2025/blob/main/data_includes/1-some.png?raw=true\"></td></table></center>Kontext: Lorem Ipsum </p><center><p>Boris se dívá na boxy a říká:</p> 1. <i>Některé trojúhelníky jsou v levém boxu.</i></p></p>Z Borisova pozorování plyne, že: <p> 3.<i> Některé XXX</i></p></center>"}, as: ["Pravdivost Borisovy první věty zaručuje pravdivost druhé věty", "Pravdivost Borisovy první věty nezaručuje pravdivost druhé věty."], presentAsScale: false, leftComment: null, rightComment: null}],
...
["second-filler2-bad", aj, {s: {html: "<center><table><table cellspacing=100><tr><td><img style=\"display:block;max-width:700px;max-height:700px;width: auto;height: auto;\" src=\"https://github.com/Rh-Hor/Exp_Dec-2025/blob/main/data_includes/1-mixed.png?raw=true\"></td></table></center>Kontext: Známý modní dům pořádal módní přehlídku nové kolekce. Bylo pozváno spoustu důležitých osob a také zástupci módních časopisů. Akci uzavírala noční přehlídka dvou světových modelek. Fotografové měli plné ruce práce.</p><center><p>Boris se dívá na boxy a říká: <i>Každý fotograf vyfotil obě modelky.</i></p></p>Z Borisova pozorování plyne, že</center>"}, as: ["Pravdivost Borisovy první věty zaručuje pravdivost druhé věty", "Pravdivost Borisovy první věty nezaručuje pravdivost druhé věty."], presentAsScale: false, leftComment: null, rightComment: null}],  

["second-filler3-bad", aj, {s: {html: "<center><table><table cellspacing=100><tr><td><img style=\"display:block;max-width:700px;max-height:700px;width: auto;height: auto;\" src=\"https://github.com/Rh-Hor/Exp_Dec-2025/blob/main/data_includes/1-mixed.png?raw=true\"></td></table></center>Kontext: Známý modní dům pořádal módní přehlídku nové kolekce. Bylo pozváno spoustu důležitých osob a také zástupci módních časopisů. Akci uzavírala noční přehlídka dvou světových modelek. Fotografové měli plné ruce práce.</p><center><p>Boris se dívá na boxy a říká: <i>Každý fotograf vyfotil obě modelky.</i></p></p>Z Borisova pozorování plyne, že</center>"}}],  
